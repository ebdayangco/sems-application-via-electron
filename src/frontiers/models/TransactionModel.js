...
class TransactionModel extends Model{
    ...
    statements(){
        ...
        function insert(){
            ...
            return `INSERT INTO transactions(facility,department,
                ...
                VALUES(
                    ...
                    "${data['model-number']}",
                    "${data['serial-number']}",
                    "${data['type-of-service'] == "Others" ? otherspecify:data['type-of-service']}",
        ...
        function getTotal(){
            return `SELECT COUNT(*) AS transTotal FROM transactions`;
        }
    ...
    process(){
        ...
        function selectAll(callback){
            self.inquireDatabase({
                "statement":self.statements().selectAll(),
                "results":function(res){
                    callback(JSON.parse(JSON.stringify(res)));
                }
            });
        ...
        function getTotal(callback){
            self.inquireDatabase({
                "statement":self.statements().getTotal(),
                "results":function(res){
                    callback(JSON.parse(JSON.stringify(res)));
                }
            });
