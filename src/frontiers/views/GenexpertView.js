    ...
    info(){
        ...
        function getOtherInformation(datas){
            ...
            function displayXpertcheck(datas){
                ...
                datas.forEach(d=>{
                    ...
                    <tr>
                        ...
                        <td>${d['fullname']}</td>
                        <td class='xpertcheck-stat'>Waiting...</td>
                    </tr>
                    `;
            ...
            async function getXpertcheck(){
                ...
                await xpertcheckController.getXpertcheckData(` AND genexpertSN="${sn}"`,function(res){
            ...
            async function getPreventiveMaintenance(){
                ...
                await preventiveMaintenanceController.getPreventiveMaintenanceData(
                    ` AND genexpertSN="${sn}"`,function(res){
            ...
            async function getServiceReport(){
                ...
                serviceReportController.getServiceReport(sn,function(res){
            ...
            return {getXpertcheck,getPreventiveMaintenance,getServiceReport}
        ...
        function displayInformation(datas){
            ...
            getOtherInformation(datas).getXpertcheck();
            getOtherInformation(datas).getPreventiveMaintenance();
            // getOtherInformation(datas).getServiceReport();
        }
