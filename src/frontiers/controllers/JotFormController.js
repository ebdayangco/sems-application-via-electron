        ...
        async function runProcess(){
            ...
            await jotform.getFormSubmissions(formID,{
                ...
                r.forEach((b,i)=>{
                        ...
                        const reportedby =  a['11'] ? `${a['11']['answer']['first']} ${a['11']['answer']['last']}` :"";
                        const reported_email = a['17'] ? a['17']['answer']:"";
                        const reported_cnum = a['10'] ? a['10']['answer']['full']:"";
                        const dop_month = a['51'] ? a['51']['answer']['month']:"01";
                        const dop_date = a['51'] ? a['51']['answer']['day']:"01";
                        const dop_year = a['51'] ? a['51']['answer']['year']:"0001";
                        const top_hr = a['51'] ? a['51']['answer']['hour']:"00";
                        const top_min = a['51'] ? a['51']['answer']['min']:"00";
                        const top_ampm = a['51'] ? a['51']['answer']['ampm']:"AM";
