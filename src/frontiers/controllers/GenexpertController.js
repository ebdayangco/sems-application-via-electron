...
class GenexpertController{
    ...
    transaction(){
        ...
        //             "loader-01":true
        //         });
        //         // check for empty fields or table row
        //         if(genexpertView.transaction().installation().validate()){
                   
        //             const datas = genexpertView.transaction().installation().entries();

        //             // check if genexpert serial number exist or not
        //             genexpertModel.process().checkExist(
        //             datas['genexpert']['serial-number'],function(){
        //                 // if genexpert serial number exist
                        
        //                 genexpertView.messager({"message-01":true,
        //                 "messages":[`${datas['genexpert']['serial-number']} already exist!`]});
        //             },function(){
        //                 // if genexpert serial number not exist
        ...
        //                     genexpertView.messager({"message-01":true,
        //                     "messages":["Duplicate module serial number."]});
        //                 }else{
        ...
        //                             datas,[insertFacility,insertContacts,insertServiceReport,
        ...
        //                                     //     'New Genexpert Installation',
        //                                     // `Genexpert SN ${datas['genexpert']['serial-number']} has been installed.`);
        ...
        //     function onSearchforTransfer(){
        //         if(genexpertView.transaction().transfer().validate()){
        //             const search_item = genexpertView.transaction()
        //             .transfer().getSearchInput();
                    
        //             genexpertModel.process().genexpertSearch(search_item,function(res){
        //                 genexpertView.transaction().transfer().displayOnSearch(res);
        //                 genexpertView.exitScreen();
        //             });
        //         }
        //     }
        //     function onTransferProcess(){
        ...
        //             const servicereportnumber = entry['service-report']['service-report-num'];
        ...
        //             genexpertModel.process().genexpertTransfer(entry['new-facility']
        //             ,entry['date-installed'],entry['serial-number'],entry['remarks'],
        //             function(res){
        ...
        //                             entry['service-report']
        //                             ['service-report-particular-id'] = res['genexpertID'];
        //                             const servicereport = entry['service-report'];
        ...
        //                             ${entry['new-facility']}`
        //                         });
        //                         genexpertView.transaction().transfer().clearAll();
        //                     });
        //                 });
        ...
        //     return {onSearchforTransfer,onTransferProcess}

        // }

        // function pullout(){

        //     function onSearchforPullOut(){
        //         if(genexpertView.transaction().pullout().validateSearchValue()){
        //             const search_item = genexpertView.transaction()
        //             .pullout().getSearchValue();
        //             genexpertModel.process().genexpertSearch(search_item,function(res){
        //                 genexpertView.transaction().pullout().displaySearchResult(res);
        //                 genexpertView.exitScreen();
        //             });
        //         }
        //     }
        //     function onPulloutProcess(){
        ...
        //             const servicereportnumber = datas['service-report']['service-report-num'];
        ...
        //                         genexpertView.messager({
        //                             "message-02":true,
        //                             "title":"Genexpert Pullout Message",
        //                             "message":`Genexpert ${datas['serial-number']} has been Terminated!`
        //                         });

        //                         genexpertView.transaction().pullout().clearAll();
        //                     });
        //                 });
        ...
        //     return {onSearchforPullOut,onPulloutProcess};
        // }
        ...
        return {installation,transfer,pullout,repair,others,search,updateOnModuleReplacement,
            ...
            pulloutOnTransaction,isSerialNumberExist};
    }
