...
class TransactionController extends Controller{
    ...
    transactionProcess(){
        ...
        //     switch(mainValidate["type-of-service"]){
        //         case "Installation": 
        //         genexpertController.transaction()
        //         .installationOnTransaction(self.insertTransaction,
        //             serviceReportController.insertServiceReport,function(err){
        //                 transactionView.messager({"message-01":true,
        //                         "messages":[err]});
        //             },function(obj){
        //                 transactionView.messager(obj);
                        
        //             });
        //         break;
        //         case "Transfer": genexpertController.transaction().transferOnTransaction(
        ...
        //         ); 
        //         break;
        //         case "Repair": genexpertController.transaction().repairOnTransaction(
        //             self.insertTransaction,
        //             serviceReportController.insertServiceReport,function(err){
        //                 transactionView.messager({"message-01":true,
        //                         "messages":[err]});
        ...
        //         break;
        //         case "Pull-out": 
        //         genexpertController.transaction().pulloutOnTransaction(
        //             self.insertTransaction,
        //             serviceReportController.insertServiceReport,function(err){
        //                 transactionView.messager({"message-01":true,
        //                         "messages":[err]});
        ...
        //         break;
        //         case "Module": 
        //             const transType = $("#transaction-module-select-transaction-field").val();
        //             if(transType == "Replacement"){
        //                 moduleController.transaction().replacement()
        //                 .replacementOnTransaction(
        //                 self.insertTransaction,
        //                 serviceReportController.insertServiceReport,function(err){
        //                     transactionView.messager({"message-01":true,
        //                             "messages":[err]});
        ...
        //                 });
        //             }else{
        //                 moduleController.transaction().installationOnTransaction(
        //                 self.insertTransaction,
        //                 serviceReportController.insertServiceReport,function(err){
        //                     transactionView.messager({"message-01":true,
        //                             "messages":[err]});
        ...
        //         break;
        //         case "Maintenance": 
        //             self.maintenanceTransaction(self.insertTransaction,
        //                 serviceReportController.insertServiceReport,function(obj){
        //                     transactionView.messager(obj);
        //                 });
        //         break;
        //         case "Others":  self.otherTransaction(self.insertTransaction,
        //             serviceReportController.insertServiceReport,function(obj){
        //                 transactionView.messager(obj);
        //             });
        ...
        async function onProcess(options){
            ...
            const transactionTotal = async function(){
                ...
                return await new Promise(resolve=>{
                    transactionModel.process().getTotal(
                       function(res){
            ...
            const getTransactions = async function(){
                ...
                return await new Promise(resolve=>{
                    transactionModel.process().selectAll(function(res){
                        resolve(res);
                    });
                });
            }
